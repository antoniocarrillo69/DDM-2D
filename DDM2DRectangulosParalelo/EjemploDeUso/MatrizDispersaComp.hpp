...
#ifndef __MatrizDispersaComp__
#define __MatrizDispersaComp____


#include "MatrizBandDisp.hpp"


/// Clase para el trabajar con matrices dispersas de punto flotante basada en el algoritmo Jagged Diagonal Storage (JDS) que puede ser compactada, pero soporta matrices con todos los valores distintos.
...
*/
class MatrizDispersaComp : public MatrizBandDisp
{
private:
...
public:
   ...
   /** @param ren Número de renglones de la matriz
       @param col Número de columnas de la matriz
       @param ban Tamaño de la banda   */
   MatrizDispersaComp(const int ren, const int col, const int ban) : MatrizBandDisp()
   {
   ...
   MatrizDispersaComp(const int ren, const int col, const int ban, const char *nmb) : MatrizBandDisp()
   {
      solicitaMemoria(ren, col, ban);
      asignaNombre(nmb);
   }
   ...
   void multiplica(MatrizDispersaComp *a, MatrizDispersaComp *b);
...
/**
Esta clase implementa los componentes para el trabajar con matrices dispersas de punto flotante que puede ser compactada
@example EjemploMatrizDispersaComp.cpp */
